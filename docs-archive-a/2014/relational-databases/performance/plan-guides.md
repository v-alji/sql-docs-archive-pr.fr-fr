...
|Explique comment utiliser SQL Server Profiler pour créer et tester des repères de plan.|[Utiliser SQL Server Profiler pour créer et tester des repères de plan](plan-guides.md)|  
