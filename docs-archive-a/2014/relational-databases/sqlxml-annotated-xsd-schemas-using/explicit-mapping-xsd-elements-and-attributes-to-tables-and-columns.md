...
### <a name="a-specifying-the-sqlrelation-and-sqlfield-annotations"></a>R. Spécification des annotations sql:relation et sql:field  
 ...
 L' `sql:relation` annotation mappe l' **\<Contact>** élément à la table Person. contact de la base de données AdventureWorks. L' `sql:field` annotation mappe l' **\<FName>** élément à la colonne FirstName et **\<LName>** à l’élément à la colonne LastName.  
