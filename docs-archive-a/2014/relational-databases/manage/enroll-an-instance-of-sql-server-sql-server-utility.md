...
|L'édition de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] doit prendre en charge l'inscription d'instance.|Pour obtenir une liste des fonctionnalités prises en charge par les éditions de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], consultez [Features Supported by the Editions of SQL Server 2014](../../getting-started/features-supported-by-the-editions-of-sql-server-2014.md).|  
