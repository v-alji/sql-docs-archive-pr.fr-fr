...
|`E_UNEXPECTED`|L'appel à la méthode était inattendu. Par exemple, la `IBCPSession2::BCPInit` méthode n’a pas été appelée avant d’appeler IBCPSession2 :: BCPSetBulkMode.|  
