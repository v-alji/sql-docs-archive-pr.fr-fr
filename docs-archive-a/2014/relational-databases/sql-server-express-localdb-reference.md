...
---
# <a name="sql-server-express-localdb-reference"></a><span data-ttu-id="16a1f-102">Référence SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="16a1f-102">SQL Server Express LocalDB Reference</span></span>
  <span data-ttu-id="16a1f-103">Cette section contient des informations sur SQL Server Express LocalDB :</span><span class="sxs-lookup"><span data-stu-id="16a1f-103">This section contains information about the SQL Server Express LocalDB:</span></span>  
  
-   [<span data-ttu-id="16a1f-104">Guide de référence des messages d’erreur propres à SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="16a1f-104">SQL Server Express LocalDB Error Message Reference</span></span>](express-localdb-error-messages/sql-server-express-localdb-reference-error-messages.md)  
  
-   [<span data-ttu-id="16a1f-105">Guide de référence de l’API d’instance SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="16a1f-105">SQL Server Express LocalDB Instance API Reference</span></span>](express-localdb-instance-apis/sql-server-express-localdb-reference-instance-apis.md)  
  
## <a name="code-sample"></a><span data-ttu-id="16a1f-106">Exemple de code</span><span class="sxs-lookup"><span data-stu-id="16a1f-106">Code Sample</span></span>  
 <span data-ttu-id="16a1f-107">L'exemple ci-dessous illustre l'API LocalDB.</span><span class="sxs-lookup"><span data-stu-id="16a1f-107">The following sample demonstrates the LocalDB API.</span></span>  <span data-ttu-id="16a1f-108">Avant d'exécuter cet exemple, assurez-vous que LocalDB est installé sur l'ordinateur.</span><span class="sxs-lookup"><span data-stu-id="16a1f-108">Make sure that LocalDB is installed on the computer before running this sample.</span></span>  <span data-ttu-id="16a1f-109">Vous pouvez installer LocalDB à partir du programme d'installation de [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span><span class="sxs-lookup"><span data-stu-id="16a1f-109">You can install LocalDB from setup in the [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span></span>  
