...
---
# <a name="spcacheremove-event-class"></a>Classe d'événements SP:CacheRemove
...
|EventSubClass|`int`|Type de sous-classe d'événements.<br /><br /> 1 = accès plan supprimer. Un plan de requête compilé a été supprimé du cache.<br /><br /> 2 = vidage du cache de procédure. Toutes les entrées ont été supprimées du cache de procédures.|21|Oui|  
