...
|UC|`int`|Temps processeur (en millisecondes) utilisé par le traitement.|18|Oui|  
...
|Lectures|`bigint`|Nombre d'E/S de lecture des pages générées par le traitement du traitement.|16|Oui|  
...
|Écritures|`bigint`|Nombre d'E/S d'écriture des pages générées par le traitement du traitement.|17|Oui|  
