...
## <a name="audit-database-object-gdr-event-class-data-columns"></a>Colonnes de la classe d'événements Audit Database Object GDR  
...
|**EventClass**|**int**|Type d’événement = 172.|27|Non|  
