...
---
# <a name="rpc-output-parameter-event-class"></a>Classe d'événements RPC Output Parameter
...
## <a name="rpc-output-parameter-event-class-data-columns"></a>Colonnes de données de la classe d'événements RPC Output Parameter  
...
|EventClass|`int`|Type d’événement = 100|27|Non|  
...
|ObjectName|`nvarchar`|Nom du paramètre référencé.|34|Oui|  
...
|TextData|`ntext`|Valeurs de paramètre de sortie de l'appel RPC.|1|Oui|  
