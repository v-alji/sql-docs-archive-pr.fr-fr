...
## <a name="audit-database-management-event-class-data-columns"></a>Colonnes de données de la classe d'événements Audit Database Management  
...
|**ObjectType**|**int**|Valeur représentant le type de l'objet qui intervient dans l'événement. Cette valeur correspond à la colonne de type de la table **sysobjects** . Pour connaître les valeurs, consultez [Colonne d’événements de trace ObjectType](objecttype-trace-event-column.md).|28|Oui|  
