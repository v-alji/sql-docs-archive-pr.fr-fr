...
|-----------|-----------------|  
|[ExistingConnection, classe d’événements](existingconnection-event-class.md)|Indique les propriétés des connexions utilisateur existantes lorsque la trace a été démarrée.|  
