...
---
# <a name="sqlbatchstarting-event-class"></a>Classe d'événements SQL:BatchStarting
  La classe d'événements SQL:BatchStarting indique qu'un lot [!INCLUDE[tsql](../../includes/tsql-md.md)] a démarré.  
  
## <a name="sqlbatchstarting-event-class-data-columns"></a>Colonnes de données de la classe d'événements SQL:BatchStarting  
...
|EventClass|`int`|Type d’événement = 13.|27|Non|  
...
|TextData|`ntext`|Texte du traitement Transact-SQL.|1|Oui|  
