...
|**BinaryData**|**image**|Nombre d'UC utilisées pour effectuer le processus sur la base des valeurs suivantes :<br /><br /> 0x00000000 : indique un plan en série s’exécutant en série.<br /><br /> 0x01000000 indique un plan parallèle s’exécutant en série.<br /><br /> >= 0x02000000 : indique qu’un plan parallèle s’exécute en parallèle.|2|Non|  
