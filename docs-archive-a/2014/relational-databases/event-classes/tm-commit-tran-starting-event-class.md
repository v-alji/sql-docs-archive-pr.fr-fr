...
## <a name="tm-commit-tran-starting-event-class-data-columns"></a>Colonnes de données de la classe d'événements TM: Commit Tran Starting  
...
|EventClass|`int`|Type d’événement = 185.|27|Non|  
