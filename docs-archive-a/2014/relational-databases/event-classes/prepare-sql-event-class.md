...
---
# <a name="prepare-sql-event-class"></a>Classe d'événements Prepare SQL
...
## <a name="prepare-sql-event-class-data-columns"></a>Colonnes de données de la classe d'événements Prepare SQL  
...
|EventClass|`int`|Type d’événement = 71.|27|Non|  
|EventSequence|`int`|Séquence d'un événement donné au sein de la demande.|51|Non|  
|GroupID|`int`|ID du groupe de charges de travail où l'événement Trace SQL se déclenche.|66|Oui|  
|Handle|`int`|Descripteur de l'instruction [!INCLUDE[tsql](../../includes/tsql-md.md)] préparée.|33|Oui|  
