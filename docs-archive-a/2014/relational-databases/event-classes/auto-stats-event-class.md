...
|**EventSubClass**|**int**|Type de sous-classe d'événements.<br /><br /> 1 : statistiques créées/mises à jour de façon synchrone ; La colonne **TextData** indique les statistiques et si elles ont été créées ou mises à jour.<br /><br /> 2 : Mise à jour asynchrone des statistiques ; mise en file d’attente du travail.<br /><br /> 3 : Mise à jour asynchrone des statistiques ; démarrage du travail.<br /><br /> 4 : Mise à jour asynchrone des statistiques ; fin du travail.|21|Oui|  
