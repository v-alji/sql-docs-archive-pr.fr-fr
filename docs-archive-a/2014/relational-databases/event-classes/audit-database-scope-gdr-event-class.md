...
# <a name="audit-database-scope-gdr-event-class"></a>Audit Database Scope GDR (classe d'événements)
  La classe d’événements **Audit Database Scope GDR** intervient chaque fois qu’une instruction GRANT, REVOKE ou DENY est émise pour une autorisation d’instruction par un utilisateur dans [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] pour les actions de base de données uniquement, comme l’octroi d’autorisations sur une base de données.  
  
## <a name="audit-database-scope-gdr-event-class-data-columns"></a>Colonnes de la classe d'événements Audit Database Scope GDR  
