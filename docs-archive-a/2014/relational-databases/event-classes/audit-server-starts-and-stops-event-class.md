...
# <a name="audit-server-starts-and-stops-event-class"></a>Audit Server Starts and Stops (classe d'événements)
  La classe d’événements **Audit Server Starts and Stops** intervient quand l’état du service [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] est modifié.  
