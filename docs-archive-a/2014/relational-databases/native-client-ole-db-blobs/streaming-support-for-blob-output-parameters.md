...
ms.locfileid: "87709276"
---
# <a name="streaming-support-for-blob-output-parameters"></a><span data-ttu-id="f4fe7-102">Prise en charge de la diffusion en continu pour les paramètres de sortie BLOB</span><span class="sxs-lookup"><span data-stu-id="f4fe7-102">Streaming Support for BLOB Output Parameters</span></span>
  <span data-ttu-id="f4fe7-103">Cette rubrique contient un exemple qui décrit la prise en charge de la diffusion en continu pour les paramètres de sortie BLOB, ce qui lie les paramètres de sortie BLOB en tant qu'interfaces ISequentialStreams.</span><span class="sxs-lookup"><span data-stu-id="f4fe7-103">This topic contains a sample that shows streaming support for BLOB output parameters, which binds BLOB output parameters as ISequentialStreams.</span></span>  
  
 <span data-ttu-id="f4fe7-104">Vos paramètres de sortie peuvent apparaître bloqués dans IMultipleResults::GetResult en recevant la valeur de retour DB_E_OBJECTOPEN.</span><span class="sxs-lookup"><span data-stu-id="f4fe7-104">You can become blocked on output parameters in IMultipleResults::GetResult, receiving DB_E_OBJECTOPEN return value.</span></span> <span data-ttu-id="f4fe7-105">L'appelant doit rechercher les paramètres d'objet BLOB, puis soit les lire en entier, soit les libérer.</span><span class="sxs-lookup"><span data-stu-id="f4fe7-105">The caller should to check for pending blob parameters, and either read them completely or release them.</span></span>  
  
## <a name="example"></a><span data-ttu-id="f4fe7-106">Exemple</span><span class="sxs-lookup"><span data-stu-id="f4fe7-106">Example</span></span>  
  
### <a name="code"></a><span data-ttu-id="f4fe7-107">Code</span><span class="sxs-lookup"><span data-stu-id="f4fe7-107">Code</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="f4fe7-108">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="f4fe7-108">See Also</span></span>  
 [<span data-ttu-id="f4fe7-109">Objets BLOB et OLE</span><span class="sxs-lookup"><span data-stu-id="f4fe7-109">BLOBs and OLE Objects</span></span>](blobs-and-ole-objects.md)  
