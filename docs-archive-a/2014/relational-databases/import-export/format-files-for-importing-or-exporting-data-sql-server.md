...
> [!NOTE]  
>  Pour plus d’informations sur cette table et la manière de la créer, consultez [Exemple de table HumanResources.myTeam &#40;SQL Server&#41;](humanresources-myteam-sample-table-sql-server.md).  
...
```  
 ...
 Pour plus d’informations, consultez [Fichiers de format non-XML &#40;SQL Server&#41;](non-xml-format-files-sql-server.md).  
...
## <a name="see-also"></a>Voir aussi  
 [Fichiers de format non-XML &#40;SQL Server&#41;](non-xml-format-files-sql-server.md)   
