...
## <a name="examples"></a>Exemples  
 Les exemples de cette rubrique importent des données en bloc à l’aide de l’instruction INSERT... SELECT * FROM OPENROWSET (BULK...) et conserve les valeurs par défaut.  
