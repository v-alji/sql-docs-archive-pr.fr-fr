...
## <a name="using-odbc-to-execute-a-natively-complied-stored-procedure"></a>Utilisation du pilote ODBC pour exécuter une procédure stockée compilée en mode natif  
