...
1.  Sur l’instance qui contient les objets sur disque que vous souhaitez migrer vers l’OLTP en mémoire, développez le nœud **gestion** dans l’Explorateur d’objets.  
