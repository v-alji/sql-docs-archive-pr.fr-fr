...
-   Restauration fragmentaire.  
    ...
    -   Utilisez la réparation de page pour résoudre l'altération de page lors de la restauration spécifique de la page. Pour plus d’informations, consultez [Restaurer des pages &#40;SQL Server&#41;](../backup-restore/restore-pages-sql-server.md).  
