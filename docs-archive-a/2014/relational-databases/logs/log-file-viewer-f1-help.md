...
# <a name="log-file-viewer-f1-help"></a>Aide sur la visionneuse du fichier journal via la touche F1
 ...
 Les journaux disponibles dépendent de la manière dont la visionneuse du fichier journal est ouverte. Pour plus d’informations, consultez [Ouvrir la Visionneuse du fichier journal](open-log-file-viewer.md).  
