 ...
 **État**  
 Affiche l'état de la base de données. Pour plus d'informations, consultez [Database States](database-states.md).  
 ...
 **Nombre d'utilisateurs**  
 Affiche le nombre d'utilisateurs connectés à la base de données.  
