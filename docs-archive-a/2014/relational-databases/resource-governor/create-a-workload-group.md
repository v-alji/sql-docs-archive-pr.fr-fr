...
##  <a name="create-a-workload-group-using-sql-server-management-studio"></a><a name="CreWGProp"></a> Créer un groupe de charge de travail avec SQL Server Management Studio  
...
##  <a name="create-a-workload-group-using-transact-sql"></a><a name="CreWGTSQL"></a> Créer un groupe de charge de travail avec Transact-SQL  
