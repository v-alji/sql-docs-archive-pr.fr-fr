...
```  
 ...
 Pour plus d’informations sur les procédures stockées, consultez [Procédures stockées &#40;Moteur de base de données&#41;](stored-procedures/stored-procedures-database-engine.md).  
  
 Pour plus d’informations sur la signature de procédures stockées, consultez [ADD SIGNATURE &#40;Transact-SQL&#41;](/sql/t-sql/statements/add-signature-transact-sql).  
