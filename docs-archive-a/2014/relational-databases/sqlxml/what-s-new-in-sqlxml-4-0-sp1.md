...
-   [Mappage par défaut d'éléments et d'attributs XSD à des tables et des colonnes](../sqlxml-annotated-xsd-schemas-using/default-mapping-of-xsd-elements-and-attributes-to-tables-and-columns-sqlxml-4-0.md)  
  
-   [Insertion de données à l'aide de codes de mise à jour (updategrams) XML](../sqlxml-annotated-xsd-schemas-xpath-queries/updategrams/inserting-data-using-xml-updategrams-sqlxml-4-0.md)  
