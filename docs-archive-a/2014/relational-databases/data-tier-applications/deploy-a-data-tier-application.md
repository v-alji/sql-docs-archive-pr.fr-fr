...
###  <a name="sql-server-utility"></a><a name="SQLUtility"></a>Utilitaire SQL Server  
...
###  <a name="database-options-and-settings"></a><a name="DBOptSettings"></a>Options et paramètres de base de données  
...
##  <a name="using-the-deploy-data-tier-application-wizard"></a><a name="UsingDeployDACWizard"></a>Utilisation de l’Assistant Déploiement de l’application de la couche données  
...
##  <a name="select-dac-package-page"></a><a name="Select_dac_package"></a>Page Sélectionner le package DAC  
...
##  <a name="update-configuration-page"></a><a name="Update_configuration"></a>Page mettre à jour la configuration  
...
##  <a name="deploy-page"></a><a name="Deploy"></a>Page déployer  
...
##  <a name="using-powershell"></a><a name="DeployDACPowerShell"></a> Utilisation de PowerShell  
