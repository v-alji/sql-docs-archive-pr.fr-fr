...
1.  Pour chaque colonne de données en cours d’exécution, entrez des valeurs spéciales dans les mémoires tampon précédemment liées par [SQLBindCol](../native-client-odbc-api/sqlbindcol.md) :  
