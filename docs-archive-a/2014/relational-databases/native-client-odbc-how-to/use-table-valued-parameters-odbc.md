...
ms.locfileid: "87600870"
---
# <a name="use-table-valued-parameters-odbc"></a><span data-ttu-id="65fb0-102">Utiliser des paramètres table (ODBC)</span><span class="sxs-lookup"><span data-stu-id="65fb0-102">Use Table-Valued Parameters (ODBC)</span></span>
  <span data-ttu-id="65fb0-103">Cet exemple indique comment utiliser les paramètres table pour insérer plusieurs lignes à plusieurs colonnes, avec un seul appel au serveur.</span><span class="sxs-lookup"><span data-stu-id="65fb0-103">This sample shows how to use table-valued parameters to insert multiple rows, with multiple columns, with one call to the server.</span></span>  
  
 <span data-ttu-id="65fb0-104">Pour plus d’informations sur les paramètres table, consultez [paramètres table &#40;ODBC&#41;](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).</span><span class="sxs-lookup"><span data-stu-id="65fb0-104">For more information about table-valued parameters, see [Table-Valued Parameters &#40;ODBC&#41;](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).</span></span> <span data-ttu-id="65fb0-105">Pour obtenir des exemples supplémentaires sur les paramètres table, consultez [ODBC Table-Valued Parameter Programming Examples](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md).</span><span class="sxs-lookup"><span data-stu-id="65fb0-105">For more samples using table-valued parameters, see [ODBC Table-Valued Parameter Programming Examples](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="65fb0-106">Exemple</span><span class="sxs-lookup"><span data-stu-id="65fb0-106">Example</span></span>  
 <span data-ttu-id="65fb0-107">Vous aurez besoin d'une source de données ODBC appelée TVPDemo.</span><span class="sxs-lookup"><span data-stu-id="65fb0-107">You will need an ODBC data source called TVPDemo.</span></span> <span data-ttu-id="65fb0-108">La base de données par défaut pour TVPDemo peut être n'importe quelle base de données de test sur votre ordinateur.</span><span class="sxs-lookup"><span data-stu-id="65fb0-108">The default database for TVPDemo can be any test database on your computer.</span></span> <span data-ttu-id="65fb0-109">Cette source de données doit être basée sur le pilote ODBC pour [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.</span><span class="sxs-lookup"><span data-stu-id="65fb0-109">This data source must be based on the ODBC driver for [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.</span></span>  
  
 <span data-ttu-id="65fb0-110">Si vous générez et exécutez cet exemple comme une application 32 bits sur un système d'exploitation 64 bits, vous devez créer la source de données ODBC avec l'administrateur ODBC dans %windir%\SysWOW64\odbcad32.exe.</span><span class="sxs-lookup"><span data-stu-id="65fb0-110">If you will build and run this sample as a 32-bit application on a 64-bit operating system, you must create the ODBC data source with the ODBC Administrator in %windir%\SysWOW64\odbcad32.exe.</span></span>  
  
 <span data-ttu-id="65fb0-111">Cet exemple vous permet de vous connecter à l'instance de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] par défaut de votre ordinateur.</span><span class="sxs-lookup"><span data-stu-id="65fb0-111">This sample connects to your computer's default [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="65fb0-112">Pour vous connecter à une instance nommée, modifiez la définition de la source de données ODBC pour spécifier l'instance en utilisant le format suivant : serveur\namedinstance.</span><span class="sxs-lookup"><span data-stu-id="65fb0-112">To connect to a named instance, change the definition of the ODBC data source to specify the instance using the following format: server\namedinstance.</span></span> <span data-ttu-id="65fb0-113">Par défaut, [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] est installé dans une instance nommée.</span><span class="sxs-lookup"><span data-stu-id="65fb0-113">By default, [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] installs to a named instance.</span></span>  
  
 <span data-ttu-id="65fb0-114">Compilez la liste de code (C++)  avec odbc32.lib et user32.lib.</span><span class="sxs-lookup"><span data-stu-id="65fb0-114">Compile the (C++) code listing with odbc32.lib and user32.lib.</span></span> <span data-ttu-id="65fb0-115">Assurez-vous que votre variable d'environnement INCLUDE inclut le répertoire qui contient sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="65fb0-115">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
