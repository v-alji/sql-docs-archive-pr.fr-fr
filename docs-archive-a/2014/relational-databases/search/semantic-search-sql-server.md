...
##  <a name="what-can-i-do-with-semantic-search"></a><a name="whatcanido"></a>Que puis-je faire avec la recherche sémantique ?  
...
###  <a name="find-the-key-phrases-in-a-document"></a><a name="find1"></a>Rechercher les expressions clés dans un document  
...
###  <a name="find-similar-or-related-documents"></a><a name="find2"></a>Rechercher des documents similaires ou connexes  
...
###  <a name="find-the-key-phrases-that-make-documents-similar-or-related"></a><a name="find3"></a>Rechercher les expressions clés qui rendent des documents similaires ou connexes  
...
##  <a name="storing-documents-in-sql-server"></a><a name="store"></a>Stockage de documents dans SQL Server  
