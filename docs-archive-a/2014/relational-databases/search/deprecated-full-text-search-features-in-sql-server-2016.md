...
|------------------------|-----------------|------------------|----------------|  
|Propriété FULLTEXTCATALOGPROPERTY : LogSize|Aucun.|FULLTEXTCATALOGPROPERTY **('consigner')**|211|  
...
|Option CREATE FULLTEXT CATALOG :<br /><br /> DANS le chemin d’accès'*RootPath*'<br /><br /> ON FILEGROUP *filegroup*|Aucun.|CREATE FULLTEXT CATLOG IN PATH<br /><br /> Aucun.*|237<br /><br /> None.<sup>*</sup>|  
...
## <a name="see-also"></a>Voir aussi  
 [SQL Server, objet de fonctionnalités déconseillées](../performance-monitor/sql-server-deprecated-features-object.md)   
