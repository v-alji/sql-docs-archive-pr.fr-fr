...
|ID de l’événement|264|  
|Source de l’événement|Runtime de base de données locale SQL Server 12.0|  
|Composant|API d'exécution de la base de données locale|  
|Texte du message|Une erreur inattendue s'est produite dans un appel de méthode d'API d'instance de base de données locale. Pour plus d'informations sur l'erreur, consultez le journal des applications Windows.|  
