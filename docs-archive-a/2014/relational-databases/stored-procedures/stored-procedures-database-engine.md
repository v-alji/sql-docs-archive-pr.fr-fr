...
## <a name="benefits-of-using-stored-procedures"></a>Avantages de l'utilisation des procédures stockées  
 ...
 Les procédures peuvent être chiffrées, ce qui permet d'obfusquer le code source. Pour plus d’informations, consultez [SQL Server Encryption](../security/encryption/sql-server-encryption.md)  
...
|Explique comment créer une procédure stockée.|[Créer une procédure stockée](../stored-procedures/create-a-stored-procedure.md)|  
|Explique comment modifier une procédure stockée.|[Modifier une procédure stockée](../stored-procedures/modify-a-stored-procedure.md)|  
