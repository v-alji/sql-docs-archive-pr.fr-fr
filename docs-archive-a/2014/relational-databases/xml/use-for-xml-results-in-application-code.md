...
-   Appliquer la [TYPE Directive in FOR XML Queries](type-directive-in-for-xml-queries.md) pour renvoyer les résultats des requêtes contenant des données de type texte ou image au format XML  
