...
ms.locfileid: "87612797"
---
# <a name="retrieving-error-information"></a><span data-ttu-id="21509-102">Extraction des informations sur les erreurs</span><span class="sxs-lookup"><span data-stu-id="21509-102">Retrieving Error Information</span></span>
  <span data-ttu-id="21509-103">Cet exemple obtient des informations à partir des différentes interfaces d’erreur exposées par le [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] fournisseur de OLE DB Native Client.</span><span class="sxs-lookup"><span data-stu-id="21509-103">This example obtains information from the various error interfaces exposed by the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB provider.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="21509-104">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="21509-104">See Also</span></span>  
 [<span data-ttu-id="21509-105">Erreurs</span><span class="sxs-lookup"><span data-stu-id="21509-105">Errors</span></span>](errors.md)  
