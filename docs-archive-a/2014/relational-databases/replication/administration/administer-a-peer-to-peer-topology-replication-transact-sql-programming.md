...
5.  Exécutez [sp_addarticle](/sql/relational-databases/system-stored-procedures/sp-addarticle-transact-sql) pour créer l'article sur chaque nœud de la topologie. Pour plus d’informations, consultez [définir un Article](../publish/define-an-article.md).  
