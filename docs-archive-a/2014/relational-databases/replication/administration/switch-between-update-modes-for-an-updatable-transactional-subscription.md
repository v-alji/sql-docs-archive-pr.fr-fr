...
2.  [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
 ...
 Pour plus d’informations sur l’accès à la boîte de dialogue **Propriétés de l’abonnement - \<Publisher> : \<PublicationDatabase>** , consultez [Afficher et modifier les propriétés d’un abonnement par extraction](../view-and-modify-pull-subscription-properties.md).  
