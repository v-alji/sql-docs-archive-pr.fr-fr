...
Dans SQL Server 2014, la réplication transactionnelle prend en charge les mises à jour sur les abonnés par le biais d’abonnements pouvant être mis à jour et d’une réplication d’égal à égal. Les deux types d’abonnements pouvant être mis à jour sont les suivants :  
...
[Basculer entre les modes de mise à jour d’un abonnement transactionnel pouvant être mis à](../administration/switch-between-update-modes-for-an-updatable-transactional-subscription.md)jour.  
