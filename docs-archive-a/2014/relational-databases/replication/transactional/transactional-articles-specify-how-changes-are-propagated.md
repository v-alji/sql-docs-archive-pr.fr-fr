...
-   **sp_MSdel_\<** *tablename* **>** , qui gère les suppressions.  
 ...
 Le **\<***tablename***>** utilisé dans la procédure varie en fonction de la méthode employée pour ajouter l’article à la publication et si la base de données d’abonnement contient une table avec un nom identique mais avec un propriétaire différent.  
