...
-   de supprimer un article d'une publication en désactivant la case à cocher en regard de l'objet. Pour savoir quand les articles peuvent être supprimés, consultez [Ajouter et supprimer des articles de publications existantes](publish/add-articles-to-and-drop-articles-from-existing-publications.md).  
