...
## <a name="column-filters"></a>Filtres de colonnes  
 ...
 ![Filtrage de colonnes](../media/repl-17.gif "Filtrage de colonnes")  
...
|colonne clé étrangère|Toutes les publications créées à l'aide de l'Assistant Nouvelle publication. Vous pouvez filtrer les colonnes clés étrangère à l'aide des procédures stockées Transact-SQL. Pour plus d'informations, consultez [Define and Modify a Column Filter](define-and-modify-a-column-filter.md).|  
|La colonne **rowguid**|Publications de fusion<sup>1</sup>|  
