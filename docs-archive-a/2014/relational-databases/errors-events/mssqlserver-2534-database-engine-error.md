...
> [!CAUTION]  
>  Le fait d’exécuter REPAIR pour corriger l’erreur de correspondance [MSSQLSERVER_2533](mssqlserver-2533-database-engine-error.md) libère la page avant la reconstruction.  
