...
Consultez [les fichiers de sauvegarde doivent se trouver sur des appareils distincts des fichiers de base de données](../../database-engine/backup-files-must-be-on-separate-devices-from-the-database-files.md).
