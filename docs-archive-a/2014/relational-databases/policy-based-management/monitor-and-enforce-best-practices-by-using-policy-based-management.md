...
|SQL Server chevauchement de masque d’affinité 32 bits|[Chevauchement correct du masque d’affinité et du masque de sortie d’entrée d’affinité](correct-affinity-mask-and-affinity-input-and-output-mask-overlap.md)|  
|Chevauchement de masque d'affinité SQL Server 64 bits|[Chevauchement correct du masque d’affinité et du masque de sortie d’entrée d’affinité](correct-affinity-mask-and-affinity-input-and-output-mask-overlap.md)|  
...
|Trace par défaut SQL Server|[Fichiers journaux des traces par défaut désactivés](default-trace-log-files-disabled.md)|  
...
|Nombre maximal de threads de travail SQL Server pour SQL Server 2000 64 bits|[Vérifier le paramètre de l'option Max Worker Threads](verify-max-worker-threads-setting.md)|  
...
|Journal des événements Windows : erreur liée à un échec de requête d'E/S|[Détection de la requête de sortie d’entrée ayant échoué](detect-failed-input-and-output-requests.md)|  
