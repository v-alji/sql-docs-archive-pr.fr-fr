...
##  <a name="components-and-concepts"></a><a name="TermsAndDefinitions"></a> Composants et concepts  
 sauvegarder [verbe]  
 ...
 **Termes et définitions des supports de sauvegarde**  
 ...
 [jeu de supports en miroir](mirrored-backup-media-sets-sql-server.md)  
 Plusieurs copies (miroirs) d'un jeu de supports.  
  
##  <a name="backup-compression"></a><a name="BackupCompression"></a>Compression de la sauvegarde  
...
##  <a name="restrictions-on-backup-operations-in-sql-server"></a><a name="Restrictions"></a>Restrictions sur les opérations de sauvegarde dans SQL Server  
