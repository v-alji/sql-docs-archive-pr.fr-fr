...
##  <a name="database-backups-under-the-simple-recovery-model"></a><a name="DbBuRMs"></a> Sauvegardes de base de données en mode de récupération simple  
 ...
 ![Affiche le risque de perte du travail entre les sauvegardes de base de données](../../database-engine/media/bnr-rmsimple-1-fulldb-backups.gif "Montre le risque de perte du travail entre les sauvegardes de base de données")  
...
##  <a name="database-backups-under-the-full-recovery-model"></a><a name="DbBuRMf"></a> Sauvegardes de base de données en mode de récupération complète  
 ...
 ![Séries de sauvegardes complètes de base de données et de sauvegardes de journal](../../database-engine/media/bnr-rmfull-1-fulldb-log-backups.gif "Séries de sauvegardes complètes de base de données et de sauvegardes de journal")  
