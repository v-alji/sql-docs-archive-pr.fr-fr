...
# <a name="calling-methods"></a>Appel de méthodes
 ...
 Utilisez la gestion des exceptions pour détecter si la méthode a réussi. Pour plus d'informations, voir [Handling SMO Exceptions](handling-smo-exceptions.md).  
