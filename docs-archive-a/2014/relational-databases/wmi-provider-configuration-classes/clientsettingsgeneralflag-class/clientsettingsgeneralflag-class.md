...
# <a name="clientsettingsgeneralflag-class"></a>Classe ClientSettingsGeneralFlag
  La [classe ClientSettingsGeneralFlag](clientsettingsgeneralflag-class.md) représente les paramètres de l’indicateur général sur une instance du [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] client.  
