...
# <a name="clientsettings-class"></a>Classe ClientSettings
  La [classe ClientSettings](clientsettings-class.md) représente les [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] paramètres sur le client.  
  
 Cette classe permet la gestion par programme du client.  
