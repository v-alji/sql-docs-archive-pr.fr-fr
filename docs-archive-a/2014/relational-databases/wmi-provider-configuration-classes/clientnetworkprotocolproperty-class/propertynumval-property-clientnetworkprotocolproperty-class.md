...
# <a name="propertynumval-property-clientnetworkprotocolproperty-class"></a>Propriété PropertyNumVal (classe ClientNetworkProtocolProperty)
  Obtient la valeur numérique de la propriété actuelle référencée par la valeur de la [propriété PropertyIdx (classe ClientNetworkProtocolProperty)](clientnetworkprotocolproperty-class.md) .  
