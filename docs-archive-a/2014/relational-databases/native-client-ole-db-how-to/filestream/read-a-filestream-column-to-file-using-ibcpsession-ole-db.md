---
title: Lire une colonne FILESTREAM dans un fichier avec IBCPSession (OLE DB) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "87696832"
---
# <a name="read-a-filestream-column-to-file-using-ibcpsession-ole-db"></a><span data-ttu-id="28c10-102">Lire une colonne FILESTREAM dans un fichier à l'aide d'IBCPSession (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="28c10-102">Read a FILESTREAM Column to File Using IBCPSession (OLE DB)</span></span>
  <span data-ttu-id="28c10-103">Cet exemple lit une colonne Filestream dans un fichier à l'aide de l'interface IBCPSession et écrit un fichier de format.</span><span class="sxs-lookup"><span data-stu-id="28c10-103">This sample reads a filestream column to a file using the IBCPSession interface and writes a format file.</span></span>  
  
 <span data-ttu-id="28c10-104">Pour plus d’informations sur la fonctionnalité FileStream, consultez [prise en charge de filestream &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span><span class="sxs-lookup"><span data-stu-id="28c10-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="28c10-105">Exemple</span><span class="sxs-lookup"><span data-stu-id="28c10-105">Example</span></span>  
 <span data-ttu-id="28c10-106">Assurez-vous que votre variable d'environnement INCLUDE inclut le répertoire qui contient sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="28c10-106">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="28c10-107">Utilisez l'un des exemples suivants pour créer la table à partir de laquelle cet exemple lit :</span><span class="sxs-lookup"><span data-stu-id="28c10-107">Use one of the following samples to create the table that this sample reads from:</span></span>  
  
-   [<span data-ttu-id="28c10-108">Envoyer des données à une colonne FILESTREAM avec l’interface ISequentialStream liée au paramètre ICommandText (OLE DB) &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="28c10-108">Send Data to a FILESTREAM Column Using ISequentialStream Bound to ICommandText Parameter &#40;OLE DB&#41;</span></span>](send-data-to-filestream-isequentialstream-bound-to-icommandtext.md)  
  
-   [<span data-ttu-id="28c10-109">Envoyer des données à une colonne FILESTREAM avec IRowsetFastUpload (OLE DB) &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="28c10-109">Send Data to a FILESTREAM Column Using IRowsetFastUpload &#40;OLE DB&#41;</span></span>](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
  
 <span data-ttu-id="28c10-110">Copiez la première liste de code et collez-la dans un fichier appelé ISSHelper.h.</span><span class="sxs-lookup"><span data-stu-id="28c10-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="28c10-111">Copiez la deuxième liste de code et collez-la dans un fichier appelé ISSHelper.cpp.</span><span class="sxs-lookup"><span data-stu-id="28c10-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="28c10-112">Copiez la troisième liste de code et collez-la dans un fichier appelé IBCPSession.cpp.</span><span class="sxs-lookup"><span data-stu-id="28c10-112">Copy the third code listing and paste it into a file called IBCPSession.cpp.</span></span>  
  
 <span data-ttu-id="28c10-113">Compilez IBCPSession.cpp, ISSHelper.cpp, ole32.lib et oleaut32.lib.</span><span class="sxs-lookup"><span data-stu-id="28c10-113">Compile IBCPSession.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="28c10-114">Lorsque cet exemple est exécuté, vous devez transmettre un nom de serveur (ou serveur\nom_instance) et un nom pour le fichier de format qu'il créera.</span><span class="sxs-lookup"><span data-stu-id="28c10-114">When this sample is run, you must pass a server name (or server\instance_name) and a name for the format file it will create.</span></span>  
