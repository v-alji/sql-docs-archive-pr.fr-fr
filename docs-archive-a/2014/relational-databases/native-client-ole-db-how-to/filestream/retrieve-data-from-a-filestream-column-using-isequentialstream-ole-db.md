...
-   [Envoyer des données à une colonne FILESTREAM avec IRowsetFastUpload (OLE DB) &#40;OLE DB&#41;](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
 ...
 Copiez la troisième liste de code et collez-la dans un fichier appelé ICommandDownload.cpp.  
  
 Compilez ICommandDownload.cpp, ISSHelper.cpp, ole32.lib et oleaut32.lib.  
