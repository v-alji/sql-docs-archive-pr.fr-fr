---
title: Récupérer des données d’une colonne FILESTREAM avec ISequentialStream (OLE DB) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "87612791"
---
# <a name="retrieve-data-from-a-filestream-column-using-isequentialstream-ole-db"></a><span data-ttu-id="cf1b6-102">Récupérer des données d'une colonne FILESTREAM à l'aide d'ISequentialStream (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="cf1b6-102">Retrieve Data from a FILESTREAM Column Using ISequentialStream (OLE DB)</span></span>
  <span data-ttu-id="cf1b6-103">Cet exemple montre comment utiliser une interface ISequentialStream dans une interface ICommandText pour récupérer un enregistrement unique d'une colonne Filestream.</span><span class="sxs-lookup"><span data-stu-id="cf1b6-103">This sample shows uses an ISequentialStream interface in an ICommandText interface to retrieve a single record from a Filestream column.</span></span>  
  
 <span data-ttu-id="cf1b6-104">Pour plus d’informations sur la fonctionnalité FileStream, consultez [prise en charge de filestream &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span><span class="sxs-lookup"><span data-stu-id="cf1b6-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="cf1b6-105">Exemple</span><span class="sxs-lookup"><span data-stu-id="cf1b6-105">Example</span></span>  
 <span data-ttu-id="cf1b6-106">Assurez-vous que votre variable d'environnement INCLUDE inclut le répertoire qui contient sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="cf1b6-106">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="cf1b6-107">Utilisez l'un des exemples suivants pour créer la table à partir de laquelle cet exemple lit :</span><span class="sxs-lookup"><span data-stu-id="cf1b6-107">Use one of the following samples to create the table that this sample reads from:</span></span>  
  
-   [<span data-ttu-id="cf1b6-108">Envoyer des données à une colonne FILESTREAM avec l’interface ISequentialStream liée au paramètre ICommandText (OLE DB) &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="cf1b6-108">Send Data to a FILESTREAM Column Using ISequentialStream Bound to ICommandText Parameter &#40;OLE DB&#41;</span></span>](send-data-to-filestream-isequentialstream-bound-to-icommandtext.md)  
  
-   [<span data-ttu-id="cf1b6-109">Envoyer des données à une colonne FILESTREAM avec IRowsetFastUpload (OLE DB) &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="cf1b6-109">Send Data to a FILESTREAM Column Using IRowsetFastUpload &#40;OLE DB&#41;</span></span>](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
  
 <span data-ttu-id="cf1b6-110">Copiez la première liste de code et collez-la dans un fichier appelé ISSHelper.h.</span><span class="sxs-lookup"><span data-stu-id="cf1b6-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="cf1b6-111">Copiez la deuxième liste de code et collez-la dans un fichier appelé ISSHelper.cpp.</span><span class="sxs-lookup"><span data-stu-id="cf1b6-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="cf1b6-112">Copiez la troisième liste de code et collez-la dans un fichier appelé ICommandDownload.cpp.</span><span class="sxs-lookup"><span data-stu-id="cf1b6-112">Copy the third code listing and paste it into a file called ICommandDownload.cpp.</span></span>  
  
 <span data-ttu-id="cf1b6-113">Compilez ICommandDownload.cpp, ISSHelper.cpp, ole32.lib et oleaut32.lib.</span><span class="sxs-lookup"><span data-stu-id="cf1b6-113">Compile ICommandDownload.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="cf1b6-114">Lorsque cet exemple est exécuté, vous devez transmettre un nom de serveur (ou serveur\nom_instance).</span><span class="sxs-lookup"><span data-stu-id="cf1b6-114">When this sample is run, you must pass a server name (or server\instance_name).</span></span>  
