...
##  <a name="connecting-to-the-database-engine-from-another-computer"></a><a name="otherComp"></a>Connexion au Moteur de base de données à partir d’un autre ordinateur  
...
##  <a name="connecting-using-the-sql-server-browser-service"></a><a name="browser"></a>Connexion à l’aide du service SQL Server Browser  
