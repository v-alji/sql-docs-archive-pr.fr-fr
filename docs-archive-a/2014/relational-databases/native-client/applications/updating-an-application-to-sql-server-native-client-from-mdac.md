...
-   Les chaînes de connexion MDAC autorisent une valeur booléenne ( `true` ) pour le mot clé **Trusted_Connection** . Une [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] chaîne de connexion Native Client doit utiliser `yes` ou **non**.  
