...
# <a name="performing-bulk-copy-operations"></a>Exécution d'opérations de copie en bloc
 ...
 Pour obtenir un exemple d’application qui illustre cette fonctionnalité, consultez [Copier des données en bloc avec IRowsetFastLoad &#40;OLE DB&#41;](../../native-client-ole-db-interfaces/irowsetfastload-ole-db.md).  
