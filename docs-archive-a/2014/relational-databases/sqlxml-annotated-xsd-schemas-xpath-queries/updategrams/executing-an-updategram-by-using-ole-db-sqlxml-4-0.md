...
```  
 ...
 La requête XPath dans le modèle est exécutée sur le schéma de mappage suivant :  
...
#### <a name="passing-parameters-to-templates"></a>Transmission des paramètres aux modèles  
 Cet exemple montre comment les valeurs de paramètre peuvent être passées aux commandes XML. Ce modèle XML est spécifié en tant que commande :  
