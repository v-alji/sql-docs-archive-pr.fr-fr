...
1.  Dans un dossier sur votre ordinateur, copiez l’un des DiffGrams et le schéma XSD correspondant dans l’un des exemples des [exemples DiffGram](diffgram-examples-sqlxml-4-0.md).  
