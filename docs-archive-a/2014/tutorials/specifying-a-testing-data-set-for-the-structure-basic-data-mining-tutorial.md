...
1.  Sur la page **créer un jeu de test** , pour **pourcentage de données à tester**, laissez la valeur par défaut `30` .  
...
1.  Dans la page **fin de l’Assistant** , dans nom de la **structure d’exploration de données**, tapez `Targeted Mailing` .  
  
2.  Dans **nom du modèle d’exploration de données**, tapez `TM_Decision_Tree` .  
