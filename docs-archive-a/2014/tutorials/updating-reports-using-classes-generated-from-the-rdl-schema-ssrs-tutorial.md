...
-   Créez une application à l’aide du [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] modèle de projet d’application console.  
