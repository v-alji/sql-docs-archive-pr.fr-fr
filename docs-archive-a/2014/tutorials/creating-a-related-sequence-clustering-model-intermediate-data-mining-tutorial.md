...
3.  Dans la boîte de dialogue **nouveau modèle d’exploration de données** , tapez un nom de modèle, puis sélectionnez Microsoft `Sequence Clustering` .  
...
1.  Sous l’onglet **modèle d’exploration de données** , cliquez avec le bouton droit sur le nouveau modèle nommé `Sequence Clustering` , puis sélectionnez **traiter le modèle**.  
