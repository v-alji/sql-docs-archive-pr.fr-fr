...
##  <a name="optional-generic-content-tree-viewer"></a><a name="bkmk_Content"></a>Facultatif Visionneuse de l’arborescence de contenu générique  
 En plus de la visionneuse personnalisée pour la série chronologique, [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] fournit la **visionneuse de l’arborescence de contenu MicrosoftGeneric** à utiliser avec tous les modèles d’exploration de données. Cette visionneuse offre quelques avantages :  
