...
1.  Cliquez sur l’onglet **structure d’exploration** de données ou l’onglet modèles d' **exploration** de données du concepteur d’exploration de données dans [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] .  
