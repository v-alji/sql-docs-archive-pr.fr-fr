...
10. Dans la page **fin de l’Assistant** , pour **nom**de la structure d’exploration de données, tapez `Sequence Clustering with Region` .  
  
11. Pour le **nom du modèle d’exploration de données**, tapez `Sequence Clustering with Region` .  
