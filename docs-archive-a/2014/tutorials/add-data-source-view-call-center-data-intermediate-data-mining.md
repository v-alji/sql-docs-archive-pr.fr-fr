...
6.  Dans la page **fin de l’Assistant** , la vue de source de données est nommée par défaut [!INCLUDE[ssAWDWsp](../includes/ssawdwsp-md.md)] . Remplacez le nom par **callcenter**, puis cliquez sur **Terminer**.  
...
|Appels|Nombre d'appels reçus pendant la période de travail de l'équipe.|  
...
|Orders (Commandes)|Nombre de commandes qui ont fait suite à des appels.|  
