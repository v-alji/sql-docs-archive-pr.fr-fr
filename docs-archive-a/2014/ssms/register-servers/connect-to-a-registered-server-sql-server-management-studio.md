...
#### <a name="to-connect-to-a-registered-server"></a>Pour se connecter à un serveur inscrit  
  
1.  Dans Serveurs inscrits, cliquez avec le bouton droit sur un serveur, pointez sur **Se connecter**, puis cliquez sur **Explorateur d’objets**.  
