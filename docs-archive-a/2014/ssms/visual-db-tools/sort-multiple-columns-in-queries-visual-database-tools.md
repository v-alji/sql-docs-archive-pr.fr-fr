...
# <a name="sort-multiple-columns-in-queries-visual-database-tools"></a>Trier plusieurs colonnes dans des requêtes (Visual Database Tools)
  Vous pouvez spécifier l’ordre dans lequel vous souhaitez utiliser les colonnes pour trier les données à l’aide de la colonne **Ordre de tri** du [volet Critères](visual-database-tools.md).  
