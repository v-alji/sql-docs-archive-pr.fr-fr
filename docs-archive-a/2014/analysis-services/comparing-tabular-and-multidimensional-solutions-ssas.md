...
-   [Prise en charge des langages de requêtes et de script](#bkmk_lang)  
...
##  <a name="overview-of-modeling-in-analysis-services"></a><a name="bkmk_overview"></a>Vue d’ensemble de la modélisation dans Analysis Services  
...
##  <a name="data-source-support-by-solution-type"></a><a name="bkmk_ds"></a>Prise en charge des sources de données par type de solution  
...
##  <a name="model-features"></a><a name="bkmk_models"></a>Fonctionnalités du modèle  
...
> [!NOTE]  
>  La modélisation tabulaire est prise en charge dans des éditions spécifiques de SQL Server. Pour plus d’informations, consultez [fonctionnalités prises en charge par les éditions de SQL Server 2014](../../2014/getting-started/features-supported-by-the-editions-of-sql-server-2014.md).  
...
##  <a name="model-size"></a><a name="bkmk_modelsize"></a>Taille du modèle  
...
##  <a name="programmability-and-developer-experience"></a><a name="bkmk_ext"></a>Programmabilité et expérience des développeurs  
...
##  <a name="query-and-scripting-language-support"></a><a name="bkmk_lang"></a>Prise en charge des langages de requête et de script  
...
##  <a name="security-feature-support"></a><a name="bkmk_sec"></a>Prise en charge des fonctionnalités de sécurité  
...
##  <a name="design-tools"></a><a name="bkmk_designer"></a>Outils de conception  
...
##  <a name="client-and-reporting-applications"></a><a name="bkmk_client"></a>Applications clientes et de création de rapports  
...
##  <a name="server-deployment-modes-for-multidimensional-and-tabular-solutions"></a><a name="bkmk_deploymentmode"></a> Modes de déploiement serveur des solutions multidimensionnelles et tabulaires  
...
##  <a name="hosting-platforms"></a><a name="bkmk_sharePoint"></a>Plateformes d’hébergement  
...
##  <a name="next-step-build-a-solution"></a><a name="bkmk_Next"></a>Étape suivante : générer une solution  
