...
---
# <a name="calculated-column-representation-tabular"></a>Représentation (tabulaire) d'une colonne calculée
...
### <a name="calculated-columns-in-amo"></a>Colonnes calculées dans AMO  
 Lorsque vous utilisez AMO pour gérer une table de modèle tabulaire, il n'existe pas de correspondance d'objet un-à-un pour une colonne calculée dans AMO. Une colonne calculée est représentée par un attribut dans <xref:Microsoft.AnalysisServices.Dimension> et un attribut dans <xref:Microsoft.AnalysisServices.MeasureGroup>.  
