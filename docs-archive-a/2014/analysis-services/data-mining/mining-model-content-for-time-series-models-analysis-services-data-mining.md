...
## <a name="understanding-the-structure-of-a-time-series-model"></a>Fonctionnement de la structure d'un modèle de série chronologique  
 ...
 ![Structure de contenu modèle pour modèles de série chronologique](../media/modelcontentstructure-ts.gif "Structure de contenu modèle pour modèles de série chronologique")  
...
### <a name="structure-of-an-arima-model"></a>Structure d'un modèle ARIMA  
 L’algorithme ARIMA crée une seule information pour chaque combinaison d’une série de données (telle que **[Region]**) et un attribut prévisible (tel que **[Sales Amount]**) : l’équation qui décrit la modification de l’attribut prévisible dans le temps.  
...
## <a name="model-content-for-time-series"></a>Contenu du modèle pour la série chronologique  
 ...
 Pour plus d’informations sur les colonnes à caractère général de l’ensemble de lignes de schéma, telles que MODEL_CATALOG et MODEL_NAME, ou pour obtenir des explications sur la terminologie relative aux modèles d’exploration de données, consultez [Contenu du modèle d’exploration &#40;Analysis Services - Exploration de données&#41;](mining-model-content-analysis-services-data-mining.md).  
...
#### <a name="mining-legend-for-an-artxp-formula"></a>Légende d'exploration de données pour une formule ARTXP  
 ...
 -0,293 * quantité (R250 Amérique du Nord,-7) + 0,069 \* quantité (R250 Europe,-1) + 0,023\*  
...
|-----------------|---------------------|----------------|----------------|-------------------|  
|Prévisions|M200 Europe:Quantity|TA00000000|27|ARIMA (1,0,1)|  
|Prévisions|M200 North America:Quantity|TA00000001|27|ARIMA (1,0,4) X (1,1,4)(6)|  
|Prévisions|M200 Pacific:Quantity|TA00000002|27|ARIMA (2,0,8) X (1,0,0)(4)|  
|Prévisions|M200 Pacific:Quantity|TA00000002|27|ARIMA (2,0,8) X (1,0,0)(4)|  
|Prévisions|R250 Europe:Quantity|TA00000003|27|ARIMA (1,0,7)|  
|Prévisions|R250 North America:Quantity|TA00000004|27|ARIMA (1,0,2)|  
|Prévisions|R250 Pacific:Quantity|TA00000005|27|ARIMA (2,0,2) X (1,1,2)(12)|  
|Prévisions|R750 Europe:Quantity|TA00000006|27|ARIMA (2,1,1) X (1,1,5)(6)|  
|Prévisions|T1000 Europe:Quantity|TA00000009|27|ARIMA (1,0,1)|  
|Prévisions|T1000 North America:Quantity|TA0000000a|27|ARIMA (1,1,1)|  
|Prévisions|T1`000 Pacific:Quantity|TA0000000b|27|ARIMA (1,0,3)|  
...
|-----------------|---------------------|------------------------|----------------|-------------------|  
|Prévisions|M200 North America:Quantity|TA00000001000000010|29|ARIMA {1,0.961832044807041}|  
|Prévisions|M200 North America:Quantity|TA00000001000000011|30|ARIMA {1,-3.51073103693271E-02,2.15731642954099,-0.220314343327742,-1.33151478258758}|  
|Prévisions|M200 North America:Quantity|TA00000001000000000|29|ARIMA {1,0.643565911081657}|  
|Prévisions|M200 North America:Quantity|TA00000001000000001|30|ARIMA {1,1.45035399809581E-02,-4.40489283927752E-02,-0.19203901352577,0.242202497643993}|  
...
|30 (Moyenne mobile ARIMA)|Valeur à t<br /><br /> Valeur à t-1<br /><br /> ...<br /><br /> Valeur à t-n|7|  
 ...
 La valeur de l' *ordre des moyennes mobiles* indique le nombre de moyennes mobiles dans une série. En règle générale, la moyenne mobile est calculée n-1 fois s’il y a n termes dans une série, mais le nombre peut être réduit pour faciliter le calcul.  
 ...
 Pour obtenir une énumération des types de valeurs possibles, consultez [Microsoft. AnalysisServices. AdomdServer. MiningValueType](/previous-versions/sql/sql-server-2014/ms144375(v=sql.120)).  
