...
##  <a name="create-a-new-project-using-the-analysis-services-project-template"></a><a name="bkmk_NewUsingTemplate"></a>Créer un nouveau projet à l’aide du modèle de projet Analysis Services  
...
##  <a name="create-a-new-project-using-an-existing-analysis-services-database"></a><a name="bkmk_NewUsingWizard"></a> Créer un nouveau projet reposant sur une base de données Analysis Services existante  
...
##  <a name="add-an-analysis-services-project-to-an-existing-solution"></a><a name="bkmk_AddtoExistingSolution"></a> Ajouter un projet Analysis Services à une solution existante  
...
##  <a name="build-and-deploy-the-solution"></a><a name="bkmk_buildDeploy"></a> Générer et déployer la solution  
...
##  <a name="analysis-services-project-folders"></a><a name="bkmk_ProjectFolders"></a>Dossiers de projet Analysis Services  
...
|Dossier|Description|  
|------------|-----------------|  
|Data Sources|Contient les sources de données d’un projet [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] . Vous pouvez créer ces objets à l'aide de l'Assistant Source de données et les modifier dans le Concepteur de source de données.|  
...
##  <a name="analysis-services-file-types"></a><a name="bkmk_FileTypes"></a> Types de fichier Analysis Services  
...
##  <a name="analysis-services-item-templates"></a><a name="bkmk_ItemTemplates"></a>Modèles d’élément Analysis Services  
