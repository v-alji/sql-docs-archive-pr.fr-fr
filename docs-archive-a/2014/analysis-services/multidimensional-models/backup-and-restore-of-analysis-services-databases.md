...
##  <a name="preparing-for-backup"></a><a name="bkmk_prep"></a>Préparation à la sauvegarde  
...
##  <a name="restoring-an-analysis-services-database"></a><a name="bkmk_restore"></a>Restauration d’une base de données Analysis Services  
