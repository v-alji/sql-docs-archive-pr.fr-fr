...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Étendre les fonctionnalités OLAP](extending-olap/extending-olap-functionality.md)  
  
 [Fournisseur OLE DB Analysis Services &#40;Analysis Services – Données multidimensionnelles&#41;](../dev-guide/analysis-services-ole-db-provider-analysis-services-multidimensional-data.md)  
  
## <a name="see-also"></a>Voir aussi  
 [Programmation de modèles tabulaires](../tabular-model-programming-compatibility-levels-1050-1103/tabular-model-programming-for-compatibility-levels-1050-through-1103.md)   
