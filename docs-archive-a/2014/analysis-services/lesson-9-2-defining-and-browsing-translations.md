...
1.  Ouvrez le Concepteur de cube pour le cube du didacticiel de [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] , puis cliquez sur l’onglet **Traductions** .  
     ...
     ![Langue par défaut sous l'onglet Traductions](../../2014/tutorials/media/l9-translations-5.gif "Langue par défaut sous l'onglet Traductions")  
...
9. Dans le volet Métadonnées, cliquez avec le bouton droit sur **Mes del Año** et sélectionnez **Ajouter à la requête**.  
     ...
     ![Noms de mois en espagnol dans le volet de données](../../2014/tutorials/media/l9-translations-7.gif "Noms de mois en espagnol dans le volet de données")  
