...
6.  Développez **Components**, puis le membre sans nom du niveau **Model Name** .
     ...
     ![Composants d'assembly servant à créer d'autres composants](../../2014/tutorials/media/l4-productdimensionerrorconfig-2.gif "Composants d'assembly servant à créer d'autres composants")
...
4.  Sélectionnez la requête SELECT DISTINCT et cliquez sur **Afficher les détails**.
     ...
     ![Clause SELECT DISTINCT affichant la clause WHERE](../../2014/tutorials/media/l4-productnametraceline-1.gif "Clause SELECT DISTINCT affichant la clause WHERE")
