...
-   [Prise en charge des classements dans Analysis Services](#bkmk_collations)  
...
-   [Améliorer les performances pour les paramètres régionaux anglais via EnableFast1033Locale](#bkmk_enablefast1033)  
...
-   0x0416 ou 1046 pour **Portugais (Brésil)**.  
 ...
 Pour afficher une liste plus longue, consultez [ID de paramètres régionaux assignés par Microsoft](https://msdn.microsoft.com/goglobal/bb964664.aspx). Pour plus d’informations sur l’arrière-plan, consultez [pages de codes](/windows/desktop/Intl/code-pages).  
