...
### <a name="to-assign-functional-area-permissions"></a>Pour affecter des autorisations de zone fonctionnelle  
...
6.  Cliquez sur une zone fonctionnelle, puis sur la flèche **Ajouter** .  
