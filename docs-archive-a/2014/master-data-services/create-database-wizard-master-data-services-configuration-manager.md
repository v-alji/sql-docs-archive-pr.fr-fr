...
|Nom du contrôle|Description|  
|------------------|-----------------|  
|**Nom d'utilisateur**|Spécifiez un compte d'utilisateur de domaine qui sera l'administrateur système [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]. Pour toutes les [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] applications Web associées à cette base de données, cet utilisateur peut mettre à jour tous les modèles et toutes les données dans toutes les zones fonctionnelles. Pour plus d’informations, consultez [administrateurs &#40;Master Data Services&#41;](administrators-master-data-services.md).|  
