...
|**TOUTES** à l’exception de **GetPermissions**, **GetRenderResource**, **GetSystemPermissions**, **ListEvents** et **ListSecureMethods**|**rsAccessDenied**|  
|**TOUTES** à l’exception de **CreateBatch**, **ExecuteBatch**, **GetSystemPolicies**, **GetSystemPermissions**, **GetSystemProperties**, **ListEvents**, **ListJobs**, **ListRoles**, **ListSchedules**, **ListSecureMethods**, **ListSubscriptions**, **ListSystemRoles**, **ListSystemTasks**, **ListTasks**|**rsMissingParameter**|  
