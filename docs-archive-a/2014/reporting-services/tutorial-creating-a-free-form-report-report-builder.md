...
4.  Vérifiez que le type de connexion est Microsoft SQL Server, puis dans la zone **chaîne de connexion** , tapez : source de **données = \<servername> **
...
## <a name="see-also"></a>Voir aussi
 [Didacticiels &#40;Générateur de rapports&#41;](report-builder-tutorials.md) [Générateur de rapports dans SQL Server 2014](report-builder/report-builder-in-sql-server-2016.md)
