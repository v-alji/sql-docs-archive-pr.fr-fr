 ...
 **Nom d'utilisateur**  
 Entrez le compte d’utilisateur de domaine qui a l’autorisation d’ajouter des fichiers au dossier partagé au format suivant : \<domain> \\<nom d’utilisateur \> .  
 ...
 **Tous les jours**  
 Définit une planification qui s'exécute les jours sélectionnés à une heure spécifique. Vous pouvez spécifier les jours des façons suivantes : chaque *\<day>* , tous les jours ouvrables et tous les *\<number>* jours. La sélection d'une option rend les autres inapplicables même si d'autres jours semblent sélectionnés.  
