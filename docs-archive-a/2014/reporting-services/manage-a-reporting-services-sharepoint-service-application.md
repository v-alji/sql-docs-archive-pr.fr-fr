...
###  <a name="session-settings"></a><a name="bkmk_session_settings_section"></a>Paramètres de session
...
|URL de lancement du Générateur de rapports|Spécifie une URL personnalisée lorsque le serveur de rapports n'utilise pas l'URL par défaut du Générateur de rapports. Ce paramètre est facultatif. Si vous ne spécifiez pas de valeur, l'URL par défaut est utilisée, laquelle lance le Générateur de rapports. Pour lancer Générateur de rapports 3,0 en tant qu’application en un clic, entrez la valeur suivante : http:// \<computername> /reportserver/reportbuilder/ReportBuilder_3_0_0_0. application.|
...
##  <a name="manage-jobs"></a><a name="bkmk_managejobs"></a>Gérer les travaux
 ...
 **Compte** Entrez un compte d'utilisateur de domaine Windows. Utilisez ce format : * \<domain> \\<compte \> d’utilisateur*.
...
##  <a name="provision-subscriptions-and-alerts"></a><a name="bkmk_provisionsubscriptions"></a>Configurer les abonnements et les alertes
