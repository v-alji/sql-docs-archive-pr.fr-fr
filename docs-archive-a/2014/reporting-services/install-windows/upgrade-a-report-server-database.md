 ...
 **Mode SharePoint :** En [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] mode SharePoint, la base de données du serveur de rapports est en fait une collection de bases de données créée pour chaque instance de l' [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] application de service.  
