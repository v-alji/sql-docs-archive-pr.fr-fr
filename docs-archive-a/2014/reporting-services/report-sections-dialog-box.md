...
# <a name="report-sections-dialog-box"></a>Boîte de dialogue Sections de rapport
  Lorsque vous ouvrez un rapport, Concepteur de rapports vérifie que le rapport contient un seul élément Report Definition Language (RDL) **\<Section>** . L’ouverture d’un rapport avec plusieurs **\<Section>** éléments n’est pas prise en charge.  
