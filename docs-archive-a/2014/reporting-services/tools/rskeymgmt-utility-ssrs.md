...
## <a name="file-location"></a>Emplacement du fichier  
 Rskeymgmt.exe se trouve à l’emplacement ** \<*drive*> suivant : \Program Files\Microsoft SQL Server\110\Tools\Binn** ou à l’emplacement ** \<*drive*> suivant : \Program Files (x86) \Microsoft SQL Server\110\Tools\Binn**. Vous pouvez exécuter l'utilitaire à partir de n'importe quel dossier de votre système de fichiers.  
