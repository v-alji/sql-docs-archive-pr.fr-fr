...
##  <a name="reports"></a><a name="bkmk_Reports"></a>État  
...
##  <a name="report-layout"></a><a name="bkmk_ReportLayout"></a>Mise en page du rapport  
...
##  <a name="preview"></a><a name="bkmk_Preview"></a>Aperçu  
...
-   **Aperçu autonome.** Exécutez le rapport local dans un navigateur. En utilisant une configuration de débogage, vous pouvez également utiliser ce mode pour déboguer les assemblys personnalisés que vous écrivez. Il existe trois manières de gérer un projet en mode débogage :  
    ...
    > [!NOTE]  
    >  Pour utiliser le mode débogage, vous devez définir un élément de départ. Dans Explorateur de solutions, cliquez avec le bouton droit sur le projet de rapport, cliquez sur **Propriétés**puis, dans `StartItem` , sélectionnez le nom du rapport à afficher.  
...
##  <a name="save-and-deploy"></a><a name="bkmk_SaveandDeploy"></a>Enregistrer et déployer  
