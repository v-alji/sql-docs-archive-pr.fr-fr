...
-   [Utilisation du script](#bkmk_how_to_use_the_script)  
  
-   [Description du paramètre](#bkmk_parameter_description)  
  
-   [Autres exemples](#bkmk_more_examples)  
...
##  <a name="supported-scenarios"></a><a name="bkmk_supported_scenarios"></a>Scénarios pris en charge  
...
###  <a name="items-and-resources-the-script-migrates"></a><a name="bkmk_what_is_migrated"></a>Éléments et ressources migrés par le script  
...
##  <a name="required-permissions"></a><a name="bkmk_required_permissions"></a> Autorisations requises  
...
##  <a name="how-to-use-the-script"></a><a name="bkmk_how_to_use_the_script"></a>Comment utiliser le script  
...
##  <a name="parameter-description"></a><a name="bkmk_parameter_description"></a>Description du paramètre  
...
##  <a name="more-examples"></a><a name="bkmk_more_examples"></a>Autres exemples  
  
###  <a name="native-mode-report-server-to-native-mode-report-server"></a><a name="bkmk_native_2_native"></a>Serveur de rapports en mode natif vers serveur de rapports en mode natif  
 L’exemple suivant migre le contenu du mode natif **Sourceserver** au mode natif **Targetserver**.  
...
##  <a name="sharepoint-mode--bi-site-collection-to-a-native-mode-server-on-azure-virtual-machine"></a><a name="bkmk_sharepoint_site_to_native_Azure_vm"></a>Mode SharePoint-collection de sites « bi » vers un serveur en mode natif sur une machine virtuelle Azure  
 L'exemple suivant migre le contenu :  
...
-   Impossible de se connecter au serveur : http:// \<servername> /reportserver/ReportService2010.asmx  
...
## <a name="see-also"></a>Voir aussi  
 [UtilitaireRS.exe &#40;SSRS&#41;](rs-exe-utility-ssrs.md)   
