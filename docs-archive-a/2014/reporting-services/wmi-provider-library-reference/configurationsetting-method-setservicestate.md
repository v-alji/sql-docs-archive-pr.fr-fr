 ...
 *EnableWebService*  
 `Boolean`Valeur indiquant l’état du [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] service Web. La valeur `true` démarre le service Web Report Server ; la valeur `false` arrête le service Web.  
