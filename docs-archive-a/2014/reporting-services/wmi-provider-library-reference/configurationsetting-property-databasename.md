...
---
# <a name="databasename-property-wmi-msreportserver_configurationsetting"></a>Propriété DatabaseName (WMI MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>Valeurs de la propriété  
 Objet `String` dont la valeur représente le nom d'instance de base de données de la base de données du serveur de rapports.  
