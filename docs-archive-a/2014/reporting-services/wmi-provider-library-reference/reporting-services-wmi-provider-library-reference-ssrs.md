...
## <a name="classes"></a>Classes  
 ...
 Pour plus d’informations sur les opérations WMI, consultez la documentation du SDK WMI inclus dans le [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] Kit de développement logiciel (SDK).  
