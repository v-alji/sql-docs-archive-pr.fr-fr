...
---
# <a name="windowsserviceidentityconfigured-property-wmi-msreportserver_configurationsetting"></a>Propriété WindowsServiceIdentityConfigured (WMI MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>Valeurs de la propriété  
 Valeur `String` contenant l'identité sous laquelle le service Windows Report Server a été configuré la dernière fois pour son exécution.  
