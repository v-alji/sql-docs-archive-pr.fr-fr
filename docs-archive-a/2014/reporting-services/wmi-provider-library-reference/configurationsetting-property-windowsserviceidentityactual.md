...
---
# <a name="windowsserviceidentityactual-property-wmi-msreportserver_configurationsetting"></a>Propriété WindowsServiceIdentityActual (WMI MSReportServer_ConfigurationSetting)
  Identité sous laquelle le service Windows Report Server s'exécute. Lecture seule.  
