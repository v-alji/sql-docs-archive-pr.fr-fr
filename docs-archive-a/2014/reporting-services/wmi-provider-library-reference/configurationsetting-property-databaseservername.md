...
---
# <a name="databaseservername-property-wmi-msreportserver_configurationsetting"></a>Propriété DatabaseServerName (WMI MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>Valeurs de la propriété  
 Objet `String` qui représente le nom du serveur.  
