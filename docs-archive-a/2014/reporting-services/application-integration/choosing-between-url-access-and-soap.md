...
# <a name="choosing-between-url-access-and-soap"></a>Choix entre l'accès URL et SOAP
 ...
 ![Scénarios de programmation Reporting Services](../../../2014/reporting-services/media/bk-ext-04.gif "Scénarios de programmation de Reporting Services") La programmation Reporting Services prend en charge un large éventail de scénarios.
...
## <a name="see-also"></a>Voir aussi
 [Intégration de Reporting Services dans des applications](../../../2014/reporting-services/application-integration/integrating-reporting-services-into-applications.md) [intégrant Reporting Services à l’aide de SOAP](../application-integration/integrating-reporting-services-using-soap.md) [intégration de Reporting Services à l’aide](../application-integration/integrating-reporting-services-using-url-access.md) de la référence technique de l’accès URL [&#40;SSRS&#41;](../../../2014/reporting-services/technical-reference-ssrs.md)
