...
1.  Créez une application Windows à l’aide de [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[csprcs](../../includes/csprcs-md.md)] ou de [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .  
...
2.  Localisez le contrôle ReportViewer dans la **Boîte à outils**. Si la **Boîte à outils** n’est pas visible, vous pouvez y accéder à partir du menu **Affichage** en sélectionnant **Boîte à outils**.  
     ...
     ![Sélection du contrôle ReportViewer](../../../2014/reporting-services/media/windowsapp-toolboxreportviewer.png "Sélection du contrôle ReportViewer")  
...
3.  Faites glisser le contrôle ReportViewer vers l'aire de conception du Windows Form.  
 ...
 Si le rapport que vous souhaitez afficher a été déployé sur un serveur de rapports, sélectionnez l' **\<Server Report>** option dans la liste déroulante **choisir un rapport** . Une fois l' **\<Server Report>** option sélectionnée, deux propriétés supplémentaires apparaissent : **URL de Report Server** et **chemin d’accès du rapport**. **L’URL de Report Server** correspond à l’adresse du serveur de rapports et le **Chemin d’accès au rapport** correspond au chemin complet au rapport à restituer.  
 ...
 ![Sélectionner le rapport local](../../../2014/reporting-services/media/windowsapp-localreportsettings.png "Sélectionner le rapport local")  
