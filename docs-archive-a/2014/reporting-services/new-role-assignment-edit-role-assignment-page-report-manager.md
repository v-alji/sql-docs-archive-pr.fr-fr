 ...
 **Groupe ou nom d'utilisateur**  
 Tapez le nom d'un compte d'utilisateur ou de groupe pour lequel l'attribution de rôle est créée. Ce nom d'utilisateur ou de groupe doit être un compte de domaine Windows valide. Entrez le compte au format suivant : \<domain> \\<compte \> .  
