...
- En cliquant sur le bouton **Démarrer** dans la [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] barre d’outils standard.  
...
> [!NOTE]  
> Avant de déboguer un rapport, vous devez définir un élément de départ. Pour définir un élément de départ, dans Explorateur de solutions, cliquez avec le bouton droit sur le projet de rapport, cliquez sur **Propriétés**, puis dans `StartItem` , sélectionnez le nom du rapport à afficher.  
