...
1.  Cliquez avec le bouton droit dans la cellule Date, pointez sur **Ajouter un total**, puis cliquez sur **Après**.  
     ...
     Cette opération ajoute une nouvelle ligne contenant la somme des quantités et des montants en dollars pour l’intégralité du rapport, ainsi que l’étiquette **totale** de la `Date` colonne.  
