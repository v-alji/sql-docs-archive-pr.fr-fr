...
-   Les petits éléments de rapport, tels que les zones de texte ou les rectangles, avec une propriété KeepTogether explicite définie sur `true` .  
  
-   Les grands éléments de rapport, tels que les sous-rapports ou un membre de tableau matriciel non plus profond, avec une propriété KeepTogether explicite définie sur `true` .  
  
-   Les régions de données de tableau matriciel avec une propriété KeepTogether explicite définie sur `true` .  
