...
# <a name="shape-charts-report-builder-and-ssrs"></a>Graphiques à base de formes (Générateur de rapports et SSRS)
 ...
 ![Graphique en entonnoir](../media/rs-funnelchart.gif "Graphique en entonnoir")  
...
-   L'ajout d'effets 3D améliore considérablement l'apparence globale d'un type de graphique à base de formes.  
  
-   Vous pouvez appliquer des styles de dessin supplémentaires aux graphiques en secteurs et aux graphiques en anneau pour impact visuel amélioré. Pour plus d’informations, consultez [Mise en forme des couleurs des séries d’un graphique &#40;Générateur de rapports et SSRS&#41;](formatting-series-colors-on-a-chart-report-builder-and-ssrs.md).  
