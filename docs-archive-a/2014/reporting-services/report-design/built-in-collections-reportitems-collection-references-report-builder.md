...
-   Cette expression, placée dans une `ReportItem` propriété de couleur de zone de texte, affiche le texte en noir lorsque la valeur est > 0 ; sinon, la valeur est affichée en rouge :  
