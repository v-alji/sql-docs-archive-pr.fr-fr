...
##  <a name="designing-a-chart"></a><a name="DesigningChart"></a> Conception d'un graphique  
...
##  <a name="similarities-to-a-matrix"></a><a name="SimilarMatrix"></a>Similarités avec une matrice  
...
##  <a name="adding-data-to-the-chart"></a><a name="AddingData"></a> Ajout de données au graphique  
...
##  <a name="category-and-series-groups-in-a-chart"></a><a name="GroupsInChart"></a> Groupes d'abscisses et groupes de séries dans un graphique  
...
##  <a name="dataset-considerations-before-creating-a-chart"></a><a name="DatasetConsiderations"></a> Considérations sur les datasets avant de créer un graphique  
...
##  <a name="best-practices-when-displaying-data-in-a-chart"></a><a name="BestPractices"></a> Meilleures pratiques lors de l'affichage de données dans un graphique  
...
##  <a name="aggregating-values-from-a-data-field-on-the-chart"></a><a name="AggregateValues"></a> Agrégation des valeurs d'un champ de données sur le graphique  
