...
## <a name="choosing-a-chart-type"></a>Choix d'un type de graphique  
 ...
 Des exemples de bon nombre de ces types de graphiques sont disponibles sous forme d'exemples de rapports. Pour plus d’informations sur le téléchargement des exemples de rapports, consultez [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [Générateur de rapports et concepteur de rapports exemples de rapports](https://go.microsoft.com/fwlink/?LinkId=198283).  
