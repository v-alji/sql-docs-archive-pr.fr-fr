...
##  <a name="gauge-types"></a><a name="GaugeTypes"></a>Types de jauges
 ...
 Outre ces différences, les deux types de jauges sont interchangeables. Toutefois, si vous devez utiliser une jauge simple dans votre rapport, vous devez envisager d'utiliser un indicateur au lieu d'une jauge. Pour plus d’informations, consultez [Indicateurs &#40;Générateur de rapports et SSRS&#41;](indicators-report-builder-and-ssrs.md).
...
### <a name="methods-of-adding-data-to-a-gauge"></a>Méthodes d'ajout de données à une jauge
...
### <a name="defining-a-group-on-a-gauge"></a>Définition d'un groupe sur une jauge
 ...
 Vous pouvez ajouter un groupe à la jauge lorsque, par exemple, vous affichez plusieurs jauges dans une table ou une liste et que vous souhaitez afficher des données agrégées par groupe. Pour plus d’informations, consultez [Ajouter ou supprimer un groupe dans une région de données &#40;générateur de rapports et des&#41;SSRS ](add-or-delete-a-group-in-a-data-region-report-builder-and-ssrs.md).


##  <a name="positioning-elements-in-a-gauge"></a><a name="PositioningData"></a>Positionnement des éléments dans une jauge
...
### <a name="positioning-gauge-scale-labels-and-gauge-ranges"></a>Positionnement des étiquettes d'échelle de jauge et des plages de jauge
...
## <a name="see-also"></a>Voir aussi
 [Expressions &#40;générateur de rapports et ssrs&#41;](expressions-report-builder-and-ssrs.md) [Filtrer, regrouper et trier des données &#40;Générateur de rapports et SSRS&#41;](filter-group-and-sort-data-report-builder-and-ssrs.md) les [paramètres de rapport &#40;générateur de rapports et concepteur de rapports](report-parameters-report-builder-and-report-designer.md)&#41;les [graphiques &#40;générateur de rapports et](charts-report-builder-and-ssrs.md) ssrs&#41;les listes &#40;générateur de rapports [et SSRS&#41;](tables-matrices-and-lists-report-builder-and-ssrs.md)
