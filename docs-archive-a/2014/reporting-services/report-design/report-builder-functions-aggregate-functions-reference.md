...
|[Count](report-builder-functions-count-function.md)|Retourne le nombre de valeurs non Null spécifiées par l'expression, évaluée dans le contexte de l'étendue donnée.|  
...
|[VarP](report-builder-functions-varp-function.md)|Retourne la variance de remplissage de toutes les valeurs numériques non Null spécifiées par l'expression, évaluée dans le contexte de l'étendue donnée.|  
...
|Contexte|RunningValue|RowNumber|First<br /><br /> Dernier|Précédente|Sum et autres fonctions Presort|Agrégats ReportItem|Fonctions de recherche|Fonction d'agrégation|  
|-------------|------------------|---------------|--------------------|--------------|-------------------------------------|---------------------------|----------------------|------------------------|  
|Valeur d'exécution|Non|Non|Non|Non|Oui|Non|Oui|Non|  
|First<br /><br /> Dernier|Non|Non|Non|Non|Oui|Non|Non|Non|  
|Précédente|Oui|Oui|Oui|Non|Oui|Non|Oui|Non|  
...
##  <a name="calculating-running-values"></a><a name="CalculatingRunningValues"></a>Calcul des valeurs en cours d’exécution  
...
##  <a name="looking-up-values-from-another-dataset"></a><a name="LookupFunctions"></a>Recherche de valeurs à partir d’un autre jeu de données  
...
|**Fonction**|**Description**|  
|------------------|---------------------|  
|[First](report-builder-functions-first-function.md)|Retourne la première valeur dans l'étendue donnée de l'expression spécifiée.|  
...
##  <a name="retrieving-server-aggregates"></a><a name="RetrievingServerAggregates"></a>Récupération des agrégats de serveur  
...
|Fonction|Description|  
|--------------|-----------------|  
|[Niveau](report-builder-functions-level-function.md)|Retourne le niveau de profondeur actuel d'une hiérarchie récursive.|  
