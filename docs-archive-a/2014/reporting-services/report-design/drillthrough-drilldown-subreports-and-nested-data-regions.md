...
##  <a name="summary-of-characteristics"></a><a name="SummaryCharacteristics"></a> Résumé des caractéristiques  
...
##  <a name="details-of-characteristics"></a><a name="Details"></a> Détails des caractéristiques  
  
###  <a name="datasets-they-use"></a><a name="Datasets"></a> Datasets utilisés  
...
###  <a name="retrieving-data"></a><a name="RetrieveData"></a> Récupération de données  
...
###  <a name="processing-and-rendering"></a><a name="ProcessRender"></a> Traitement et rendu  
...
###  <a name="use-of-parameters"></a><a name="Parameters"></a> Utilisation de paramètres  
...
###  <a name="reusability"></a><a name="Reusability"></a> Possibilité de réutilisation  
...
###  <a name="display"></a><a name="Display"></a> Affichage  
