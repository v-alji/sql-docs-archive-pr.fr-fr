...
-   Cette expression fournit le nom du rapport ainsi que l'heure de son exécution. L’heure est mise en forme avec la [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] chaîne de mise en forme pour la date abrégée :  
