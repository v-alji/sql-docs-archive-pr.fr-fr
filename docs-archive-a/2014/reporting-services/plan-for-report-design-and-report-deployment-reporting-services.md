...
-   **Générateur de rapports :** téléchargez un rapport vers un serveur de rapports configuré en mode natif à partir du Gestionnaire de rapports.  
  
-   **SharePoint :** téléchargez un rapport vers un site SharePoint configuré avec un serveur de rapports en mode SharePoint.  
  
-   **Par programmation :** publiez par programmation un rapport à l'aide des interfaces SOAP API vers un serveur de rapports. Pour plus d'informations, consultez [Report Server Web Service](report-server-web-service/report-server-web-service.md).  
