...
1.  Ouvrez RSReportServer.config dans un éditeur de texte.  
     ...
     Le fichier se trouve à l’emplacement * \<drive> suivant :* \Program Files\Microsoft SQL Server\MSRS12. MSSQLSERVER\Reporting Services\ReportServer.  
