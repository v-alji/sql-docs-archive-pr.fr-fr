...
-   [Vue d'ensemble de la gestion des planifications partagées](#bkmk_overview)  
...
##  <a name="overview-of-managing-shared-schedules"></a><a name="bkmk_overview"></a>Vue d’ensemble de la gestion des planifications partagées  
...
##  <a name="create-and-manage-shared-schedules-native-mode"></a><a name="bkmk_native"></a>Créer et gérer des planifications partagées (mode natif)  
