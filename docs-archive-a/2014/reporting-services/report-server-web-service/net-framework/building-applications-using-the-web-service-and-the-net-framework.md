...
|-----------|-----------------|  
|[Création du proxy de service Web](creating-the-web-service-proxy.md)|Décrit les manières d’ajouter une classe proxy à votre projet à l’aide de [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] .|  
...
|[Appel des méthodes de service Web](calling-web-service-methods.md)|Décrit comment utiliser l’API SOAP pour appeler des méthodes de service Web dans [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] .|  
