...
|Paramètre|Valeur|  
|-------------|-----------|  
|**À**|Adresse de messagerie qui apparaît sur la ligne `To` du message électronique. Les adresses de messagerie multiples sont séparées par des points-virgules. Obligatoire.|  
...
|**COPIE**|Adresse de messagerie qui apparaît sur la ligne `Bcc` du message électronique. Les adresses de messagerie multiples sont séparées par des points-virgules. facultatif.|  
...
|**Priorité**|Priorité avec laquelle le message électronique est envoyé. Les valeurs correctes sont `LOW`, `NORMAL` et `HIGH`. La valeur par défaut est `NORMAL`.|  
...
## <a name="see-also"></a>Voir aussi  
 [Référence technique &#40;SSRS&#41;](../../technical-reference-ssrs.md)   
