...
# <a name="creating-the-web-service-proxy"></a>Création du proxy de service Web
 ...
 Il existe deux façons d’ajouter une classe proxy à votre projet de développement à l’aide de l' [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] : avec l’outil WSDL dans le [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] , et en ajoutant une référence Web dans [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] . Les sections suivantes approfondissent ce sujet.  
