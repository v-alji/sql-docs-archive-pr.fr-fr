...
### <a name="hyperlinks-and-drillthrough"></a>Liens hypertexte et extraction  
 Les liens hypertexte et les liens d’extraction sont rendus sous forme de liens hypertexte sur les éléments de rapport à l’aide des balises d’ancrage HTML ( \<a> ) autour de l’élément sur lequel ils sont définis.  
