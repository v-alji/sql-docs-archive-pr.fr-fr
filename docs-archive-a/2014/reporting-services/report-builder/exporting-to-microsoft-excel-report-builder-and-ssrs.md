...
# <a name="exporting-to-microsoft-excel-report-builder-and-ssrs"></a>Exportation vers Microsoft Excel (Générateur de rapports et SSRS)
 ...
 Vous pouvez modifier certains paramètres par défaut pour ce convertisseur en modifiant les paramètres d'informations de périphérique. Pour plus d’informations, voir [Excel Device Information Settings](../excel-device-information-settings.md).  
...
>   
>  Pour plus d'informations sur ce problème, consultez [CORRECTIF : SSRS 2012 ne peut pas exporter un rapport d'une taille supérieure à 10 Mo au format Excel](https://go.microsoft.com/fwlink/p/?LinkId=402513)  
>   
...
> [!IMPORTANT]  
>  L'extension de rendu [!INCLUDE[ofprexcel](../../../includes/ofprexcel-md.md)] 2003 est déconseillée. Pour plus d’informations, consultez [fonctionnalités déconseillées dans SQL Server Reporting Services dans SQL Server 2014](../deprecated-features-in-sql-server-reporting-services-ssrs.md).  
