...
# <a name="report-sections-dialog-box-report-builder"></a>Boîte de dialogue Sections de rapport (Générateur de rapports)
  Lorsque vous ouvrez un rapport, Générateur de rapports vérifie que le rapport contient un seul élément Report Definition Language (RDL) **\<Section>** . L’ouverture d’un rapport avec plusieurs **\<Section>** éléments n’est pas prise en charge.  
