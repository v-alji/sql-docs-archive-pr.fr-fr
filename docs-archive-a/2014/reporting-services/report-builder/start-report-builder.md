...
# <a name="start-report-builder-report-builder"></a>Démarrer le Générateur de rapports (Générateur de rapports)
  [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)]comprend des versions autonomes et [!INCLUDE[ndptecclick](../../includes/ndptecclick-md.md)] de générateur de rapports. La version [!INCLUDE[ndptecclick](../../includes/ndptecclick-md.md)] peut être utilisée avec [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] en mode natif ou en mode intégré SharePoint.  
...
1.  Dans le menu Démarrer, cliquez sur **tous les programmes**, puis sur [!INCLUDE[ssCurrentUI](../../includes/sscurrentui-md.md)] **Générateur de rapports**.  
