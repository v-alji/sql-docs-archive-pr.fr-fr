...
2.  Le service Web appelle la <xref:ReportService2010.ReportingService2010.LogonUser%2A> méthode de votre extension de sécurité, plus précisément la classe qui implémente **IAuthenticationExtension**.  
