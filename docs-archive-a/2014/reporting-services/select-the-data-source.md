 ...
 **Type**  
 Sélectionnez le type de source de données que vous utilisez (par exemple, si vous utilisez une [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] base de données, choisissez [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] ).  
