...
|111|Error|Journalisation|Serveur de rapports<br /><br /> Gestionnaire de rapports|*\<Source>* Impossible de créer le journal des traces. Pour plus d’informations, consultez [Report Server Service Trace Log](../report-server/report-server-service-trace-log.md).|  
...
|130|Error|Gestion|Serveur de rapports<br /><br /> Processeur de planification et de remise|*\<Source>* fichier de configuration introuvable. Des fichiers de configuration sont nécessaires pour le serveur de rapports.|  
