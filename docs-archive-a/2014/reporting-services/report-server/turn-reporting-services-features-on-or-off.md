...
4.  Sous **Propriétés de la facette**:  
    ...
    -   Pour activer les événements planifiés et la remise, affectez à **ScheduleEventsAndReportDeliveryEnabled** la valeur `True` .  
  
    -   Pour désactiver les événements planifiés et la remise, affectez à **ScheduleEventsAndReportDeliveryEnabled** la valeur `False` .  
...
2.  Dans l' **Explorateur d’objets**, cliquez avec le bouton droit sur le [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] nœud, pointez sur **stratégies**, puis cliquez sur **facettes**.  
  
3.  Dans la liste **Facette** , sélectionnez **Configuration de la surface d'exposition pour Reporting Services**.  
  
4.  Sous **Propriétés de la facette**:  
  
    -   Pour activer Gestionnaire de rapports, affectez à **affectez ReportManagerEnabled** la valeur `True` .  
  
    -   Pour désactiver Gestionnaire de rapports, affectez à **affectez ReportManagerEnabled** la valeur `False` .  
