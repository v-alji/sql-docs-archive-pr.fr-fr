...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Compteurs de performances pour les objets ReportServer : service et ReportServerSharePoint : service performance](performance-counters-reportserver-service-performance-objects.md)  
