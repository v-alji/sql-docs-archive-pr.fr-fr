...
2.  Dans le volet Propriétés, tapez le texte que vous souhaitez afficher en tant que message dans le `NoRowsMessage` champ de propriété.  
...
3.  Dans **légende**, tapez le texte que vous souhaitez afficher en tant que message dans le `NoDataMessage` champ de propriété.  
