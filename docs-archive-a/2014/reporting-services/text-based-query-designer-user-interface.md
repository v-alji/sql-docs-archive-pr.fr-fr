...
#### <a name="example"></a>Exemple
 ...
 Lorsque vous entrez le nom de la table Sales. Customer, cela revient à créer l' [!INCLUDE[tsql](../includes/tsql-md.md)] instruction `SELECT * FROM Sales.Customer;` .
