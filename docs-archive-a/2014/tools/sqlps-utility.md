...
### <a name="a-run-the-sqlps-utility-in-default-interactive-mode-without-the-copyright-banner"></a>R. Exécution de l’utilitaire sqlps en mode interactif par défaut, sans bannière de copyright
