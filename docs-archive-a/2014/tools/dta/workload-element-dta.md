...
## <a name="example"></a>Exemple  
 L’exemple de code suivant spécifie la table de trace **mydatabase. MyDBOwner. TuningTable001** pour l' `Workload` élément. La table **TuningTable001** a été créée à l'aide du modèle de paramétrage (Tuning) utilisé dans le Générateur de profils SQL Server et dont le résultat de trace a été enregistré comme table.  
