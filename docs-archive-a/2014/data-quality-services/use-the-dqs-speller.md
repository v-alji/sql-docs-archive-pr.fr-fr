...
##  <a name="use-the-speller"></a><a name="Use"></a> Utilisez le vérificateur d'orthographe  
...
##  <a name="follow-up-after-using-the-speller"></a><a name="FollowUp"></a> Suivi : Après utilisation du vérificateur d'orthographe  
...
##  <a name="how-the-speller-works"></a><a name="How"></a> Fonctionnement du vérificateur d'orthographe  
