...
5.  événements  
 ...
 Chaque ensemble de lignes d'informations est également écrit dans le journal de diagnostic du cluster SQL Server. Pour plus d’informations, consultez [Afficher et lire le journal de diagnostic de l’instance de cluster de basculement](view-and-read-failover-cluster-instance-diagnostics-log.md).  
...
####  <a name="determining-failures"></a><a name="determine"></a> Détermination des échecs  
 ...
 Examinez la procédure stockée système [sp_server_diagnostics &#40;Transact-SQL&#41;](/sql/relational-databases/system-stored-procedures/sp-server-diagnostics-transact-sql), car elle joue un rôle important pour les niveaux de condition d’échec.  
