...
---
# <a name="modify-indexes-that-depend-on-the-return-type-of-host_id"></a>Modifier les index qui dépendent du type d'HOST_ID retourné
  La fonction HOST_ID retourne maintenant un `char(10)`.  
