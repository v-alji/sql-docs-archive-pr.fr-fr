---
title: Configuration du nœud de cluster | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Nom** de l’instance : utilisez la liste déroulante pour sélectionner l' [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance de cluster de basculement à modifier.  
