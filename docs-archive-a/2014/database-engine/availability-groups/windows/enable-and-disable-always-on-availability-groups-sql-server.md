...
-   **Comment:**  
    ...
    -   [Activer groupes de disponibilité AlwaysOn](#EnableAOAG)  
...
##  <a name="enable-alwayson-availability-groups"></a><a name="EnableAOAG"></a> Activer les groupes de disponibilité AlwaysOn  
