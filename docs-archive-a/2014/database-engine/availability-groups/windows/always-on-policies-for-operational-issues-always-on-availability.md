...
|État de synchronisation des données des réplicas de disponibilité|[Certains réplicas de disponibilité ne synchronisent pas les données](some-availability-replicas-are-not-synchronizing-data.md).|Warning|Groupe de disponibilité|  
