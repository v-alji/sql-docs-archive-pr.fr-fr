...
```  
 ...
 Il s'agit du script d'installation [!INCLUDE[tsql](../../includes/tsql-md.md)] (`Install.sql`), qui déploie l'assembly et crée les fonctions sensibles aux caractères supplémentaires dans la base de données.  
