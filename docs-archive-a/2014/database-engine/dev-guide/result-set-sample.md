...
## <a name="building-the-sample"></a><span data-ttu-id="40990-131">Génération de l'exemple</span><span class="sxs-lookup"><span data-stu-id="40990-131">Building the Sample</span></span>  
