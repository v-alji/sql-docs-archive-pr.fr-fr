...
3.  Créez un fichier de clé de nom fort en exécutant ce qui suit à l'invite de commandes.  
...
```  
 ...
 Il s'agit du script d'installation [!INCLUDE[tsql](../../includes/tsql-md.md)] (`Install.sql`), qui déploie les assemblys et crée les procédures stockées.  
...
```  
 ...
 Le code [!INCLUDE[tsql](../../includes/tsql-md.md)] suivant supprime les assemblys et les procédures stockées de la base de données.  
