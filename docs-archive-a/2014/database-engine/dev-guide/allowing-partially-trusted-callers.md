...
### <a name="description"></a>Description  
 ...
 L'utilisation de curseurs côté serveur est coûteuse en termes de ressources du serveur et peut parfois empêcher l'optimiseur de requête de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] d'améliorer les performances de vos requêtes. Par conséquent, il se peut que vous ayez intérêt à récrire votre code afin d'utiliser des jointures dans tous les cas où il est possible de le faire.  
