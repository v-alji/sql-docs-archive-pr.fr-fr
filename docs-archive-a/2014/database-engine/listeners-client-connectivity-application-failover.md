...
##  <a name="availability-group-listeners"></a><a name="AGlisteners"></a> Écouteurs de groupe de disponibilité  
...
###  <a name="availability-group-listener-configuration"></a><a name="AGlConfig"></a> Configuration de l'écouteur de groupe de disponibilité  
...
###  <a name="selecting-an-availability-group-listener-port"></a><a name="SelectListenerPort"></a> Sélection d'un port d'écoute de groupe de disponibilité  
...
##  <a name="using-a-listener-to-connect-to-the-primary-replica"></a><a name="ConnectToPrimary"></a>Utilisation d’un écouteur pour se connecter au réplica principal  
...
##  <a name="using-a-listener-to-connect-to-a-read-only-secondary-replica-read-only-routing"></a><a name="ConnectToSecondary"></a> Utilisation d'un écouteur pour se connecter à un réplica secondaire en lecture seule (routage en lecture seule)  
...
###  <a name="to-configure-availability-replicas-for-read-only-routing"></a><a name="ConfigureARsForROR"></a> Pour configurer des réplicas de disponibilité pour le routage en lecture seule  
...
####  <a name="related-tasks"></a><a name="RelatedTasksROR"></a> Tâches associées  
...
###  <a name="read-only-application-intent-and-read-only-routing"></a><a name="ReadOnlyAppIntent"></a>Intention d’application en lecture seule et routage en lecture seule  
...
####  <a name="related-tasks"></a><a name="RelatedTasksApps"></a> Tâches associées  
...
##  <a name="bypassing-availability-group-listeners"></a><a name="BypassAGl"></a>Contournement des écouteurs de groupe de disponibilité  
...
##  <a name="supporting-availability-group-multi-subnet-failovers"></a><a name="SupportAgMultiSubnetFailover"></a> Prise en charge de basculements de sous-réseaux multiples de groupe de disponibilité  
...
##  <a name="availability-group-listeners-and-ssl-certificates"></a><a name="SSLcertificates"></a> Écouteurs de groupe de disponibilité et certificats SSL  
...
##  <a name="availability-group-listeners-and-server-principal-names-spns"></a><a name="SPNs"></a>Écouteurs de groupe de disponibilité et noms de principal de serveur (SPN)  
...
-   [Connectivité client AlwaysOn &#40;SQL Server&#41;](availability-groups/windows/always-on-client-connectivity-sql-server.md)
