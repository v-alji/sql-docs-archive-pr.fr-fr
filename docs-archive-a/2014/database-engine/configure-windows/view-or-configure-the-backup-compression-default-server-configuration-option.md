...
##  <a name="follow-up-after-you-configure-the-backup-compression-default-option"></a><a name="FollowUp"></a> Suivi : Après avoir configuré l’option Compression par défaut des sauvegardes  
