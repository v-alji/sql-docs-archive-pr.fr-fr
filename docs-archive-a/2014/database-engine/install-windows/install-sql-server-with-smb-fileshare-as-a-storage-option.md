...
-   \\\NomServeur\NomPartage  
 ...
 Pour plus d’informations sur la Convention d’affectation de noms universelle, consultez [UNC](https://go.microsoft.com/fwlink/?LinkId=245534) ( https://go.microsoft.com/fwlink/?LinkId=245534) .  
...
-   Dans l’installation à partir de l’invite de commandes, affectez à « /INSTALLSQLDATADIR » la valeur « \\\fileserver1\share1\" ».  
    ...
    ```  
     ...
     Pour plus d’informations sur l’utilisation de diverses options de paramètres de ligne de commande dans [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] , consultez [installer SQL Server 2014 à partir de l’invite de commandes](../../database-engine/install-windows/install-sql-server-from-the-command-prompt.md).  
