...
---
# <a name="sql-server-2014-transaction-log-architecture-and-management"></a>Gestion et architecture du journal des transactions SQL Server 2014

**S’applique à :** SQL Server (à partir de 2008)
