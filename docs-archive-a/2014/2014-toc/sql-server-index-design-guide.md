...
```  
 ...
 ![Le plan d'exécution indique qu'un opérateur SORT est utilisé.](media/indexsort1.gif "Le plan d'exécution indique qu'un opérateur SORT est utilisé.")  
...
```  
 ...
 ![Le plan d'exécution indique qu'aucun opérateur SORT n'est utilisé.](media/insertsort2.gif "Le plan d'exécution indique qu'aucun opérateur SORT n'est utilisé.")  
...
### <a name="clustered-index-architecture"></a>Architecture des index cluster  
 ...
 ![Niveaux d'index cluster](media/bokind2.gif "Niveaux d'index cluster")  
...
-   Si la table a un index cluster, ou si l'index est sur une vue indexée, le localisateur de ligne est la clé d'index cluster pour la ligne.  
 ...
 ![Niveaux d'index non cluster](media/bokind1.gif "Niveaux d'index non cluster")  
