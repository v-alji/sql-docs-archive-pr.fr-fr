...
## <a name="see-also"></a>Voir aussi  
 ...
 [Connexion à des sources de données dans le composant script](extending-packages-scripting/data-flow-script-component/connecting-to-data-sources-in-the-script-component.md)   
