...
|**False**|Le chemin d'accès de destination est défini dans un gestionnaire de connexions de fichiers. La sélection de cette valeur affiche l’option dynamique, `DestinationConnection` .|  
