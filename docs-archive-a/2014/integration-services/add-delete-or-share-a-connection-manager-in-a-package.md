...
-   [Pour ajouter un gestionnaire de connexions au niveau projet](#project)  
  
-   [Pour créer un paramètre pour une propriété du gestionnaire de connexions](#parameter)  
...
##  <a name="to-add-a-connection-manager-when-creating-a-package"></a><a name="wizard"></a>Pour ajouter un gestionnaire de connexions lors de la création d’un package  
...
##  <a name="to-add-a-connection-manager-to-an-existing-package"></a><a name="package"></a>Pour ajouter un gestionnaire de connexions à un package existant  
...
##  <a name="to-add-a-connection-manager-at-the-project-level"></a><a name="project"></a>Pour ajouter un gestionnaire de connexions au niveau du projet  
...
##  <a name="to-create-a-parameter-for-a-connection-manager-property"></a><a name="parameter"></a>Pour créer un paramètre pour une propriété du gestionnaire de connexions  
...
##  <a name="to-delete-a-connection-manager-from-a-package"></a><a name="DeletePackageLevel"></a>Pour supprimer un gestionnaire de connexions d’un package  
...
##  <a name="to-delete-a-shared-connection-manager-project-level-connection-manager"></a><a name="DeleteProjectLevel"></a>Pour supprimer un gestionnaire de connexions partagé (gestionnaire de connexions au niveau du projet)  
