...
5.  Entrez les informations nécessaires dans l'Assistant Nouvelle instance pour l'instance. Pour des informations sur les informations requises pour cet Assistant, consultez [Use the New Instance Wizard](use-the-new-instance-wizard.md).  
