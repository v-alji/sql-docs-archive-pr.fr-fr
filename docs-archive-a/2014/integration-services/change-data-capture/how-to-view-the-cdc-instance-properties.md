...
3.  Sélectionnez le nom de l'instance à utiliser.  
     ...
     **État**  
     Cet onglet présente des informations sur l'état actuel de la capture de données modifiées pour l'instance. Pour plus d'informations sur ce qui est affiché dans cet onglet, consultez la section **Onglets de la visionneuse** dans [Manage a CDC Instance](manage-a-cdc-instance.md).  
  
     **Oracle**  
     Cet onglet affiche des informations générales sur l'instance de capture de données modifiées et la base de données source Oracle. Pour plus d'informations sur ce qui est affiché dans cet onglet, consultez [Edit the Oracle Database Properties](edit-the-oracle-database-properties.md).  
