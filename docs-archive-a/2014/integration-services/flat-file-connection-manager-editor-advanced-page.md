...
|**TextQualified**|Indique si les données de texte sont entourées de caractères d’identificateur de texte tels que des guillemets. Les valeurs autorisées sont :<br /><br /> **True** : Les données texte du fichier plat sont qualifiées.<br /><br /> **False** : Les données texte du fichier plat ne sont pas qualifiées.|  
